...
class MaasAPITests(SynchronousTestCase):
    ...
    def createEntity(self, label):
        ...
        self.assertEqual(location, self.uri + '/entities/' + entity_id)
        return resp
    ...
    def createCheck(self, label, entity_id, is_remote=True):
        ...
        self.assertEqual(location, checks_endpoint + '/' + check_id)
        return resp
    ...
    def createAlarm(self, label, entity_id, check_id):
        ...
        self.assertEqual(location, alarms_endpoint + '/' + alarm_id)
        return resp
    ...
    def createNotification(self, label):
        ...
        self.assertEqual(location, self.uri + '/notifications/' + nt_id)
        return resp
    ...
    def createNotificationPlan(self, label):
        ...
        self.assertEqual(location, self.uri + '/notification_plans/' + np_id)
        return resp
    ...
    def createSuppression(self, label):
        ...
        self.assertEqual(location, self.uri + '/suppressions/' + sp_id)
        return resp
    ...
    def test_list_entity(self):
        ...
        self.assertEqual(data['values'][0]['label'], 'ItsAnEntity')

        (resp, data) = self.successResultOf(json_request(
            self, self.root, b"GET", '{0}/entities?marker={1}'.format(
                self.uri, data['metadata']['next_marker'])))
        self.assertEqual(resp.code, 200)
        self.assertEqual(data['values'][0]['label'], 'entity-2')
    ...
    def test_get_entity(self):
        ...
        self.assertEqual(self.entity_id, data['id'])
    ...
    def test_fail_get_entity(self):
        ...
        self.assertEqual(data['type'], 'notFoundError')
    ...
    def test_list_audits(self):
        ...
        self.assertEqual(data['values'][0]['app'], 'entities')
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['metadata']['count'], 4)
        self.assertEqual(data['values'][0]['app'], 'alarms')
    ...
    def test_list_audits_reverse(self):
        ...
        data = self.get_responsebody(resp)
        self.assertEqual(data['metadata']['count'], 2)
        self.assertEqual(data['values'][0]['app'], 'suppressions')
    ...
    def test_get_check(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(self.check_id, data['id'])
    ...
    def test_get_checks_for_entity(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(1, data['metadata']['count'])
        self.assertEqual(self.check_id, data['values'][0]['id'])
    ...
    def test_get_checks_for_missing_entity(self):
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET", '{0}/entities/enDoesNotExist/checks'.format(
                self.uri)))
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['message'], 'Parent does not exist')
    ...
    def test_create_check_missing_type_400s(self):
        ...
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['message'], 'Validation error for key \'type\'')
    ...
    def test_update_entity(self):
        ...
        self.assertEqual(entity_endpoint, one_text_header(resp, b'location'))
        req = request(self, self.root, b"GET", entity_endpoint)
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual('Iamamwhoami', data['label'])
        self.assertEqual(
            'ItsAnEntity',
    ...
    def test_update_nonexisting_entity_404s(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['message'], 'Object does not exist')
    ...
    def test_partial_update_entity(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual('ag13378901234', data['agent_id'])
        self.assertEqual('ItsAnEntity', data['label'])
    ...
    def test_get_alarm(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(self.alarm_id, data['id'])
    ...
    def test_create_alarm_missing_check_id_400s(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['message'], 'Validation error for key \'check_id\'')
    ...
    def test_create_alarm_missing_np_id_400s(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['message'], 'Validation error for key \'notification_plan_id\'')
    ...
    def test_update_check(self):
        ...
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 204)
        self.assertEqual(check_endpoint, one_text_header(resp, b'location'))
        req = request(self, self.root, b"GET", check_endpoint)
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
    ...
    def test_partial_update_check(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual('internet7_v4', data['target_alias'])
        self.assertEqual('ItsAcheck', data['label'])
    ...
    def test_update_alarm(self):
        ...
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 204)
        self.assertEqual(alarm_endpoint, one_text_header(resp, b'location'))
        req = request(self, self.root, b"GET", self.uri + '/views/overview')
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 200)
        alarm2 = self.get_responsebody(resp)['values'][0]['alarms'][0]
        self.assertEqual(alarm['label'], alarm2['label'])
    ...
    def test_partial_update_alarm(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual('np123456', data['notification_plan_id'])
        self.assertEqual('ItsAnAlarm', data['label'])
    ...
    def test_delete_alarm(self):
        ...
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 200)
        self.assertEqual(0, len(self.get_responsebody(resp)['values'][0]['alarms']))
    ...
    def test_test_check_setting_available(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(False, data[0]['available'])
    ...
    def test_test_check_setting_status(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual('whuuut', data[0]['status'])
    ...
    def test_test_check_setting_metrics(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(123, data[0]['metrics']['duration']['data'])
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"POST",
                         ...
                         json.dumps({'type': 'remote.http',
                                     'monitoring_zones_poll': ['mzdfw']}).encode("utf-8")))
        self.assertEqual(resp.code, 200)
        self.assertEqual(456, data[0]['metrics']['duration']['data'])
    ...
    def test_test_alarm_setting_state(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(1, len(data))
        self.assertEqual('OK', data[0]['state'])
        self.assertIn('timestamp', data[0])
    ...
    def test_test_alarm_setting_status(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(1, len(data))
        self.assertEqual('test status message', data[0]['status'])
    ...
    def test_test_alarm_clearing_response(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(1, len(data))
        self.assertNotEqual('test-alarm working OK', data[0]['status'])
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"POST",
                         ...
                         json.dumps({'criteria': 'return new AlarmStatus(OK).encode("utf-8");',
                                     'check_data': [{}]}).encode("utf-8")))
        self.assertEqual(resp.code, 400)
        self.assertEqual(data, parse_error)
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"POST",
                         ...
                         json.dumps({'criteria': 'return new AlarmStatus(OK).encode("utf-8");',
                                     'check_data': [{}]}).encode("utf-8")))
        self.assertEqual(resp.code, 404)
        self.assertEqual(data, not_found_error)
    ...
    def test_get_alarms_for_entity(self):
        ...
        data = self.get_responsebody(resp)
        self.assertEqual(1, data['metadata']['count'])
        self.assertEqual(self.alarm_id, data['values'][0]['id'])
    ...
    def test_delete_check(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(0, len(data['values'][0]['checks']))
        self.assertEqual(0, len(data['values'][0]['alarms']))
    ...
    def test_delete_entity(self):
        ...
        self.assertEqual(0, data['metadata']['count'])
    ...
    def test_delete_nonexistent_entity_404s(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['details'], 'Object "Entity" with key "whut" does not exist')
    ...
    def test_jsonhome(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(True, 'mimicking' in json.dumps(data))
    ...
    def test_notificationplan(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(True, 'npTechnicalContactsEmail' in json.dumps(data))
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET",
                         '{0}/views/agent_host_info?entityId={1}&include=system'.format(
                             self.uri, self.entity_id)))
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['message'], 'Agent does not exist')
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET",
                         '{0}/views/agent_host_info?entityId={1}&include=system&include=cpus'.format(
                             self.uri, self.entity_id)))
        self.assertEqual(resp.code, 200)
        self.assertEqual(self.entity_id, data['values'][0]['entity_id'])
    ...
    def test_agenthostinfo_missing_entity_id_returns_400(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(True, data['type'] == 'badRequest')
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET",
                         '{0}/views/agent_host_info?entityId={1}'.format(
                             self.uri, self.entity_id)))
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['message'], 'Validation error for key \'include\'')
    ...
    def test_view_connections_missing_agentid_400s(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['message'], 'Validation error for key \'agentId\'')
    ...
    def test_view_connections(self):
        ...
        self.assertEqual(len(connections_by_agent_id[agent_id]), 3)
        self.assertEqual(len(connections_by_agent_id['agent-that-does-not-exist']), 0)
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET",
                         '{0}/views/agent_host_info?entityId={1}&include=system'.format(
                             self.uri, self.entity_id)))
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['details'], 'Agent LOLWUT does not exist')
    ...
    def test_metriclist(self):
        ...
        data = self.get_responsebody(resp)
        self.assertEqual(self.entity_id, data['values'][0]['entity_id'])
        self.assertEqual(self.check_id, data['values'][0]['checks'][0]['id'])
    ...
    def test_unknown_check_type_returns_empty_metrics_list(self):
        ...
        self.assertEqual(chupacabra_check[0]['metrics'], [])
    ...
    def test_metrics_list_agent_check(self):
        ...
        self.assertEqual(cpu_check[0]['metrics'][0]['name'], 'user_percent_average')
    ...
    def test_multiplot(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(500, len(data['metrics'][0]['data']))
    ...
    def test_multiplot_missing_check_returns_400(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'requiredNotFoundError')
    ...
    def test_multiplot_unknown_check_type(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(data['metrics'][0]['type'], 'unknown')
        self.assertEqual(len(data['metrics'][0]['data']), 0)
    ...
    def test_get_all_notification_plans(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(2, data['metadata']['count'])
    ...
    def test_get_notification_plan(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['id'], self.np_id)
        req = request(self, self.root, b"GET",
                      self.uri + '/notification_plans/npTechnicalContactsEmail')
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['id'], 'npTechnicalContactsEmail')
    ...
    def test_update_notification(self):
        ...
        self.assertEqual('changed', mynt['label'])
    ...
    def test_delete_nonexistent_notification_404s(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['details'], 'Object "Notification" with key "ntWhut" does not exist')
    ...
    def test_update_notificationplan(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual('changed', data['label'])
    ...
    def test_delete_nonexistent_notification_plan_404s(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['details'], 'Object "NotificationPlan" with key "npWhut" does not exist')
    ...
    def test_get_notificationtypes(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(4, data['metadata']['count'])
    ...
    def test_get_suppression(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['id'], self.sp_id)
        self.assertEqual(data['notification_plans'], [])
    ...
    def test_get_all_suppressions(self):
        ...
        data = self.get_responsebody(resp)
        self.assertEqual(1, data['metadata']['count'])
        self.assertEqual(self.sp_id, data['values'][0]['id'])
    ...
    def test_delete_nonexistent_suppression_404s(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['details'], 'Object "Suppression" with key "spWhut" does not exist')
    ...
    def test_list_alarm_examples(self):
        ...
        data = self.get_responsebody(resp)
        ax = data['values'][0]
        self.assertEqual('remote.http_body_match_1', ax['id'])
    ...
    def test_alarm_count_per_np(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['values'][0]['alarm_count'], 1)
        self.assertEqual(data['values'][0]['notification_plan_id'], 'npTechnicalContactsEmail')
    ...
    def test_alarms_by_np(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['values'][0]['id'], self.alarm_id)
    ...
    def test_unicode_label(self):
        ...
        """
        req = request(self, self.root, b"POST", self.uri + '/entities',
                      json.dumps({'label': '\u0CA0_\u0CA0'}).encode("utf-8"))
        resp = self.successResultOf(req)
        self.assertEqual(resp.code, 201)
    ...
    def test_overview_pagination(self):
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['values'][0]['entity']['label'], 'ItsAnEntity')
        ...
        self.assertEqual(resp.code, 200)
        data = self.get_responsebody(resp)
        self.assertEqual(data['values'][0]['entity']['label'], 'entity-2')
    ...
    def test_latest_alarm_states(self):
        ...
        self.assertEqual(resp.code, 200)
        self.assertEqual(data['values'][0]['latest_alarm_states'][0]['state'], 'CRITICAL')
    ...
    def test_change_log(self):
        ...
        self.assertEqual(should_be_ok['state'], 'OK')
        self.assertEqual(should_be_critical['state'], 'CRITICAL')
        self.assertEqual(should_be_critical['entity_id'], self.entity_id)
        self.assertEqual(should_be_critical['check_id'], self.check_id)
        self.assertEqual(should_be_critical['alarm_id'], self.alarm_id)
    ...
    def test_alarm_states_same_alarm_gets_previous_state(self):
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"GET", '{0}/views/latest_alarm_states'.format(self.uri)))
        self.assertEqual(resp.code, 200)
        self.assertEqual(data['values'][0]['latest_alarm_states'][0]['previous_state'], 'CRITICAL')
    ...
    def test_create_alarm_state_missing_state_400s(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['details'], 'Missing required key (state)')
    ...
    def test_create_alarm_state_missing_status_400s(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['details'], 'Missing required key (status)')
    ...
    def test_set_overrides_missing_check(self):
        ...
        self.assertEqual(resp.code, 404)
        self.assertEqual(data['type'], 'notFoundError')
        self.assertEqual(data['details'], ('Object "Check" with key ' +
    ...
    def test_set_overrides_unknown_type(self):
        ...
        self.assertEqual(resp.code, 400)
        self.assertEqual(data['type'], 'badRequest')
        self.assertEqual(data['details'], 'Unknown value for "type": "lolwut"')
        ...
        (resp, data) = self.successResultOf(
            json_request(self, self.root, b"POST",
                         ...
                         json.dumps({'metrics': [{'entity_id': self.entity_id,
                                                  ...
                                                  'metric': 'mzord.available'}]}).encode("utf-8")))
        self.assertEqual(resp.code, 200)
        self.assertEqual(data['metrics'][0]['data'][0]['average'], 11)
        self.assertEqual(data['metrics'][0]['data'][1]['average'], 22)
