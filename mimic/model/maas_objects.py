...
@attributes([Attribute('agent_id', default_value=None),
             ...
             Attribute('id',
                       default_factory=(lambda: u'en' + random_hex_generator(4).decode("utf-8")),
...
@attributes([Attribute('created_at', instance_of=int),
             ...
             Attribute('id',
                       default_factory=(lambda: u'ch' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
             Attribute('label', default_value=u'', instance_of=text_type),
             Attribute('metadata', default_factory=dict, instance_of=dict),
...
@attributes([Attribute('check_id', instance_of=text_type),
             ...
             Attribute('entity_id', instance_of=text_type),
             Attribute('id',
                       default_factory=(lambda: u'al' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
             Attribute('label', default_value=u'', instance_of=text_type),
             Attribute('metadata', default_factory=dict, instance_of=dict),
...
@attributes([Attribute('created_at', instance_of=int),
             Attribute('details', default_factory=dict, instance_of=dict),
             Attribute('id',
                       default_factory=(lambda: u'nt' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
             Attribute('label', default_value=u'', instance_of=text_type),
             Attribute('metadata', default_factory=dict, instance_of=dict),
...
@attributes([Attribute('created_at', instance_of=int),
             ...
             Attribute('id',
                       default_factory=(lambda: u'np' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
             Attribute('label', default_value=u'', instance_of=text_type),
             Attribute('metadata', default_factory=dict, instance_of=dict),
...
@attributes([Attribute('alarms', default_factory=list, instance_of=list),
             ...
             Attribute('id',
                       default_factory=(lambda: u'sp' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
             Attribute('label', default_value=u'', instance_of=text_type),
...
@attributes([Attribute('alarm_changelog_id',
             ...
             Attribute('entity_id', instance_of=text_type),
             Attribute('id',
                       default_factory=(lambda: u'as' + random_hex_generator(4).decode("utf-8")),
                       instance_of=text_type),
